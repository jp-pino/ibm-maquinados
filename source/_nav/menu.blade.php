...
<nav class="flex items-center justify-between flex-wrap bg-blue-900 p-6 fixed w-full z-40 opacity shadow">
	<div class="flex items-center flex-shrink-0 text-white mr-6">
		<img src="/assets/img/ibm-notext.png" class="fill-current h-8 w-8 mr-2" width="30" height="30"/>
	...
	<div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto hidden">
		<div class="text-sm lg:flex-grow">
			<a href="/" class="block mt-4 lg:inline-block lg:mt-0 hover:text-white mr-4 {{ $page->isActive('') ? 'text-white' : 'text-blue-400' }}">
				Inicio
			</a>
			<a href="/about" class="block mt-4 lg:inline-block lg:mt-0 hover:text-white mr-4 {{ $page->isActive('/about') ? 'text-white' : 'text-blue-400' }}">
				Nosotros
			</a>
			<a href="/products" class="block mt-4 lg:inline-block lg:mt-0 hover:text-white mr-4 {{ $page->isActive('/products') ? 'text-white' : 'text-blue-400' }}">
				Productos
			</a>
...
@push('scripts')
<script src="/assets/build/js/classie.js"></script>
<script src="/assets/build/js/Modernizr.js"></script>
